  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4">
        <div
          className={`glass rounded-2xl px-4 sm:px-6 py-3 flex items-center justify-between transition-all duration-300 ${
            scrolled ? "shadow-[0_10px_40px_-10px_oklch(0_0_0/0.4)]" : ""
          }`}
        >
          ...
          <div className="hidden lg:flex items-center gap-2">
            ...
            <Link
              to="/join"
              className="glow-btn px-5 py-2.5 text-sm font-medium rounded-xl bg-gradient-to-r from-primary to-accent text-white"
            >
              Join Now
            </Link>
          </div>
